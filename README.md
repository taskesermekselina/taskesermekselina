...
<h3 align="center">Yönetim Bilişim Sistemleri Öğrencisi | Backend & Mobil Geliştirici | Veri Odaklı Çözümler</h3>
...
💻 ASP.NET Core ile backend sistemler geliştiriyorum  
📱 Flutter ile mobil uygulamalar geliştiriyorum  
📊 Web Mining, Veri Madenciliği ve Sentiment Analysis projeleri üretiyorum  
🤖 AI destekli analiz sistemleri üzerine çalışıyorum  
...
<!--
**taskesermekselina/taskesermekselina** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
